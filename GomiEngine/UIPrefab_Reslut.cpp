...
UIHandle UIPrefab_Result(UIManager& manager, const UISpawnDef& def)
{
	...
	UIText text("", 32, Anchor::CENTER, { def.pos.x + 400, def.pos.y + 200 }, def.layer, 1, true);

	UIButton child1("", "ui_hover", "ui_hover", { def.pos.x + 400 - 64, def.pos.y + 300 - 28 }, { 2, 2 }, def.layer, 1, []() { EventBus::getInstance().emit<int>("WorldChange", 1); }, true);
	UIText childText("RESTART", 32, Anchor::CENTER, { def.pos.x + 400, def.pos.y + 300 }, def.layer, 2, true);
